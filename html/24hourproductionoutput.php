...
<head>
	...
	<!--meta http-equiv="refresh" content="60; URL='https://tci-bt-linux01/dev-oee/salesdashboard.php'"-->
        <title>24 Hour Work Center Output</title>
...
<table style="width: 100%; max-width: 100%; border: 0px solid #000;">
    ...
    <div class="header-bar">
        ...
        <h2 class="header-title">
            24 Hour Operational Efficiency
        </h2>
...
<table style="width: 100%; border: 0px solid #000;">
        <tr> 
            ...
            <table style="
			    ...
			    <!-- PO: Controls a light blue border around the words
				 "Shift Aggregate" in the main navigation menu  -->
                            <td colspan=2 style="font-weight: bold; text-align: center; background-color: lightgrey; border: 0px solid #ddecf0;">
                                <a href="./oeeoperatorefficiency.php" style="text-decoration: none; color: #000;">Shift Aggregate</a>
                            </td>
                        </tr>
				 ...
				 the main navigation menu  -->
                            <th style="width='50%'; width: 100%; border: 0px solid #000;">
                                <?php
                                    ...
                                    echo firstShiftYesterdayTotalManufacturingReceiptQuantity($conn);
                                ?>
                            </th>
                        </tr>
			    ...
			    <!-- PO: controls the border around the 3rd Shift numbers (footage) in the
				 main navigation menu  -->
                        ...
                        <tr>
			    <!-- PO: Controls a light blue border around the words
				 "Month-to-Date" in the main navigation menu  -->
                            <td colspan=2 style="font-weight: bold; text-align: center; background-color: lightgrey; border: 0px solid #ddecf0;">
                                Month-to-Date
                            </td>
                        </tr>
			...
			<!-- Month-to-Date  -->
                        <tr>
			    <!-- PO: controls the border around the words "1st Shift" Month-to-Date
				 on the right side, in the main navigation menu  -->
                            <th style="width='50%'; width: 100%; border: 0px solid #000;">
                                <strong><p>
			    ...
			    <!-- PO: controls the border around the 1st Shift total in
				 the main navigation menu  -->
                            <th style="width='50%'; width: 100%; border: 0px solid #000;">
                                <?php
                                    $conn = connectRubiconTci();
                                    echo firstShiftMonthToDateTotalManufacturingReceiptQuantity($conn);
                                ?>
			</tr>

                        <tr>
			    <!-- PO: controls the border around the text "2nd Shift" Month-to-Date on
				 the right side, in the main navigation menu  -->
                            <th style="width='50%'; width: 100%; border: 0px solid #000;">
                                <strong><p>
			    ...
			    <!-- PO: controls the border around the 2nd Shift numbers (footage) in the
				 main navigation menu  -->
                            <th style="width='50%'; width: 100%; border: 0px solid #000;">
                                <?php
                                    $conn = connectRubiconTci();
                                    echo secondShiftMonthToDateTotalManufacturingReceiptQuantity($conn);
                                ?>
                            </th>
                        </tr>

                        <tr>
			    <!-- PO: controls the border around the text "3rd Shift" Month-to-Date -->
                            <th style="width='50%'; width: 100%; border: 0px solid #000;">
                                <strong><p>
			    ...
			    <!-- PO: controls the border around the 3rd Shift numbers (footage) in the
				 main navigation menu  -->
                            <th style="width='50%'; width: 100%; border: 0px solid #000;">
                                <?php
                                    $conn = connectRubiconTci();
                                    echo thirdShiftMonthToDateTotalManufacturingReceiptQuantity($conn);
                                ?>
                            </th>
                        </tr>

                        <tr>
			    <!-- PO: controls the border around the text "Total" Month-to-Date -->
                            <th style="width='50%'; width: 100%; border: 0px solid #000;">
                                <strong><p>
                                <a href="./oeeoperatorefficiency.php" style="text-decoration: none; color: #000;">Total</a>
                            </th style="width='50%'; width: 100%;">
			    <!-- PO: controls the border around the 3rd Shift numbers (footage) in the
				 main navigation menu  -->
                            <th style="width='50%'; width: 100%; border: 0px solid #000;">
                                <?php
                                    $conn = connectRubiconTci();
                                    echo monthToDateTotalManufacturingReceiptQuantity($conn);
                                ?>
                            </th>
                        </tr>
...
<!-- Aligns tables side-by-side...not sure how this works?  -->
<th style="text-align: center;">

	<table style="max-width: 100%; border: 2px solid #000; align: center;">
                            <tr  rowspan=2 style="background-color: lightgrey;">
                                <td colspan=4 style="font-size: 2.25rem; text-align: center;  font-weight: bold;">Work Center Status</td>
                            </tr>
                            <tr rowspan=2 style="background-color: lightgrey;">
				...
				<?php echo date('l, m/d/y', strtotime('yesterday')); ?>
                                </p>
                                        <?php
                                            $fontSize = isset($_GET['size']) ? htmlspecialchars($_GET['size']) : '14px';
                                            $today = (new DateTime())->modify('-1 day')->format('Y-m-d');
                                        ?>
                                </td>
                            </tr>
                            <tr style="background-color: lightgrey; font-weight: bold; font-size: 16px;">
                                ...
                                <?php
                                    $conn = connectRubiconTci();
                                    echo twentyFourHourWorkCenterOutput($conn);
                                ?>
                                </td>
                            </tr>
                        </table>

<!-- Aligns tables side-by-side...not sure how it does it?  -->
	<td>
<th style="text-align: center;">
    		<?php
        		$conn = connectRubiconTci();
        		echo firstShiftYesterdayManufacturingReceiptsTable($conn);
    		?>
	</td>
	<td>
<!-- Aligns tables side-by-side...not sure how it does it?  -->
<th style="text-align: center;">
    		<?php
        		$conn = connectRubiconTci();
        		echo secondShiftYesterdayManufacturingReceiptsTable($conn);
    		?>
	</td>
<!-- Aligns tables side-by-side...not sure how it does it?  -->
	<td>
<th style="text-align: center;">
    		<?php
        		$conn = connectRubiconTci();
        		echo thirdShiftYesterdayManufacturingReceiptsTable($conn);
    		?>
	</td>
</body>
</html>
